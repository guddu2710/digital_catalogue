...
class MobileverifyDuplicate extends StatefulWidget {
  String phone;
  String email;
  String password;
  MobileverifyDuplicate({Key key, this.phone,this.email,this.password}) : super(key: key);
  @override
  _MobileverifyDuplicateState createState() => _MobileverifyDuplicateState();
}

class _MobileverifyDuplicateState extends State<MobileverifyDuplicate> {
  ...
  _verifyOtp() {
    ...
    print(getOtp);
    print("hi");
    if (otpController.text == getOtp.toString()) {
      print("ho");
